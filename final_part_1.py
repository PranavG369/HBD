...
def display_birthday_wish(name, language):
    if language == "Hindi":
        ...
        st.write("नरम सी तुझसे जुड़ी हर बात लगती है ख़ास,",
                "इशारे तेरे, जैसे चाँदनी का मधुर एहसास।",
                "वादे नहीं, पर तेरा साथ हर पल में है,",
                "एक पल भी तुझसे दूर रहना आसान नहीं है।",
                "दिल की हर धड़कन तुझमें ही खो जाती है,",
                "इश्क़ मेरा तेरी मुस्कान में झलकती है।",
                "तू ही तो है जो रंग भरती है हर एक शाम में,",
                 "आज भी तू पास हो, तो दुनिया लगती है एक आरामगाह में।"
                )
